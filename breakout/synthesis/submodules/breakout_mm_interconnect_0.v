...
module breakout_mm_interconnect_0 (
	...
	wire   [5:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> processor_data_master_agent:rp_channel
	...
	wire   [5:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> processor_instruction_master_agent:rp_channel
	...
	wire  [94:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> processor_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                           // processor_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> processor_debug_mem_slave_agent:cp_channel
	...
	wire  [94:0] cmd_mux_002_src_data;                                                            // cmd_mux_002:src_data -> memory_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                           // memory_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                         // cmd_mux_002:src_channel -> memory_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> timer_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                           // timer_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> timer_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_004_src_data;                                                            // cmd_mux_004:src_data -> pio_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                           // pio_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                         // cmd_mux_004:src_channel -> pio_s1_agent:cp_channel
	...
	wire         cmd_mux_005_src_valid;                                                           // cmd_mux_005:src_valid -> spi_0_spi_control_port_agent:cp_valid
	wire  [94:0] cmd_mux_005_src_data;                                                            // cmd_mux_005:src_data -> spi_0_spi_control_port_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                           // spi_0_spi_control_port_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                         // cmd_mux_005:src_channel -> spi_0_spi_control_port_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                   // cmd_mux_005:src_startofpacket -> spi_0_spi_control_port_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                     // cmd_mux_005:src_endofpacket -> spi_0_spi_control_port_agent:cp_endofpacket
	...
	wire  [94:0] processor_debug_mem_slave_agent_rp_data;                                         // processor_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] memory_s1_agent_rp_data;                                                         // memory_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [94:0] timer_s1_agent_rp_data;                                                          // timer_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] pio_s1_agent_rp_data;                                                            // pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire         spi_0_spi_control_port_agent_rp_valid;                                           // spi_0_spi_control_port_agent:rp_valid -> router_007:sink_valid
	wire  [94:0] spi_0_spi_control_port_agent_rp_data;                                            // spi_0_spi_control_port_agent:rp_data -> router_007:sink_data
	wire         spi_0_spi_control_port_agent_rp_ready;                                           // router_007:sink_ready -> spi_0_spi_control_port_agent:rp_ready
	wire         spi_0_spi_control_port_agent_rp_startofpacket;                                   // spi_0_spi_control_port_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         spi_0_spi_control_port_agent_rp_endofpacket;                                     // spi_0_spi_control_port_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         spi_0_spi_control_port_agent_rdata_fifo_src_valid;                               // spi_0_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] spi_0_spi_control_port_agent_rdata_fifo_src_data;                                // spi_0_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         spi_0_spi_control_port_agent_rdata_fifo_src_ready;                               // avalon_st_adapter_005:in_0_ready -> spi_0_spi_control_port_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                               // avalon_st_adapter_005:out_0_valid -> spi_0_spi_control_port_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                // avalon_st_adapter_005:out_0_data -> spi_0_spi_control_port_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                               // spi_0_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                               // avalon_st_adapter_005:out_0_error -> spi_0_spi_control_port_agent:rdata_fifo_sink_error
	...
	breakout_mm_interconnect_0_router_003 router_003 (
	...
	breakout_mm_interconnect_0_router_003 router_004 (
	...
	breakout_mm_interconnect_0_router_002 router_005 (
	...
	breakout_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	breakout_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	breakout_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	breakout_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	breakout_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
